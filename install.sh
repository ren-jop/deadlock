...
echo
echo "Deadlock v1.2.9 installed from the current source tree."
echo "Chrome, Helium and Firefox YouTube blocking use native browser policy; no browser Automation permission is required for those browsers.\n"
